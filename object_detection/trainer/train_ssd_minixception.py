...
parser.add_argument('-dp', '--data_path', default='/media/deepan/externaldrive1/project_repos/marine_od/marine-debris-fls-datasets/md_fls_dataset/data/watertank-segmentation',
                    type=str, help='Path for writing model weights and logs')
parser.add_argument('--bb_path', default='/media/deepan/externaldrive1/project_repos/marine_od/marine-debris-fls-datasets/weights/',
...
model = SSD_MiniXception(num_classes, weight_folder=args.bb_path)
model.summary()
